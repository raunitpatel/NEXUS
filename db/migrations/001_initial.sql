...
-- Applied: Day 2 (AGNT-003)
-- Description: Initial schema — all 7 tables with pgvector IVFFlat index
-- Note: This migration is managed manually until Alembic is integrated in AGNT-010.
--       Do not edit this file after it has been applied to any environment.
--
-- [rest of schema.sql content follows — identical to db/schema.sql]
