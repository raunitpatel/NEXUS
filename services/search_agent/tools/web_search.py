        ...
        results: list[SearchResult] = [
            {
                ...
                "snippet": (
                    f"A comprehensive overview of {query}. "
            ...
            {
                "title": f"Deep dive: {query} — Research Paper",
                "url": "https://arxiv.org/abs/mock-2024-001",
                "snippet": (
                    f"This paper presents novel findings related to {query}. "
            ...
            },
            {
                ...
                "snippet": (
                    f"Step-by-step walkthrough for implementing {query}. "
            ...
            },
            {
                ...
                "snippet": (
                    f"Industry developments in {query} as of 2024. "
