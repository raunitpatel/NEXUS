...
- `services/memory_agent/pgvector_store.py` — `insert_embedding()` and `cosine_search()`
- `services/memory_agent/embeddings.py` — `EmbeddingModel` singleton wrapping `sentence-transformers`
