...
- Dispatch tasks to standalone agent services in dependency order
...
- `services/orchestrator/nodes/dispatch_next_task.py` — resolves agent service URLs and calls `POST /run`
